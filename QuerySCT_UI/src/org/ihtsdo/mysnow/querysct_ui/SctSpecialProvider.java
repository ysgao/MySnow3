...
public class SctSpecialProvider implements SearchProvider {

    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 370115009L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(370115009); iterator.hasNext();){
