...
public class SctSearchObservableProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 363787002L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(363787002); iterator.hasNext();){
