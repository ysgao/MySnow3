...
public class SctSearchPhysicalProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 260787004L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(260787004); iterator.hasNext();){
