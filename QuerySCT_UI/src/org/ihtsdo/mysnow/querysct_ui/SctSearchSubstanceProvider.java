...
public class SctSearchSubstanceProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 105590001L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(105590001); iterator.hasNext();){
