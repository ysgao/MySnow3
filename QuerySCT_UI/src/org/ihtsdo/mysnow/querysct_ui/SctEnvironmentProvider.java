...
public class SctEnvironmentProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 308916002L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(308916002); iterator.hasNext();){
