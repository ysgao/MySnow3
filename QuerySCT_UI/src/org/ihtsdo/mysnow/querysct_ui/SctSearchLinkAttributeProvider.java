...
public class SctSearchLinkAttributeProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 106237007L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(106237007); iterator.hasNext();){
