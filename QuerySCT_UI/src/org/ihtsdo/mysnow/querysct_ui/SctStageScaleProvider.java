...
public class SctStageScaleProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 254291000L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(254291000); iterator.hasNext();){
