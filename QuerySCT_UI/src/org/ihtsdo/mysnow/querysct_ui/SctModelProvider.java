...
public class SctModelProvider implements SearchProvider {

    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    Node node = querysct.getNodebyID(900000000000441003L);
    Collection<Node> allsctnodes= querysct.getAllSctNodes(node);
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(419891008); iterator.hasNext();){
