...
public class SctSearchOrganismProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    Node node; 
    Collection<Node> allsctnodes=null;

    public SctSearchOrganismProvider() {
        node= querysct.getNodebyID(410607006);
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(410607006); iterator.hasNext();){
