...
public class SctSearchEventProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 272379006L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(272379006); iterator.hasNext();){
