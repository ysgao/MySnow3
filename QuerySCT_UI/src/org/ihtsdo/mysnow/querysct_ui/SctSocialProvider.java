...
public class SctSocialProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 48176007L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(48176007); iterator.hasNext();){
