...
public class SctSearchPharmaceuticalProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 373873005L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(373873005); iterator.hasNext();){
