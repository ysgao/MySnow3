...
public class SctSearchQualifierProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 362981000L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(362981000); iterator.hasNext();){
