...
public class SctSpecimenProvider implements SearchProvider {
    private static QuerySCT querysct = Lookup.getDefault().lookup(QuerySCT.class);
    private static final long ROOT_ID = 123038009L;
...
//          for (Iterator<Node> iterator =querysct.getAllSctNodeIterator(123038009); iterator.hasNext();){
